...
> 이 문서는 `Core_RnR_v0_1_d32.md` 기준으로 작성되었습니다.
...
이 문서는 시스템 개발 영역별 R&R을 정리한 본체 산출물입니다. SRS·SAD 본체를 참고하되 현재 개발 상황에 맞춰 전반적으로 재구성되고 있습니다. Dashboard·SignalR Hub·Command API는 추후 개발 예정이며 이 문서에서는 제외됩니다.
