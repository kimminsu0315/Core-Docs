...
> 이 문서는 `Core_ICD_AMMR_v0_1_d21.md` 기준으로 작성되었습니다.
...
| `timestamp`   | string  | 필수 | ISO 8601 UTC (예: `2026-07-10T07:30:00.123Z`) — 발행 시점         |
...
sequenceDiagram
    ...
    Note over A,B: CONNECT (Client ID, Keep Alive 60초,<br/>Clean Start=true, Session Expiry=0, LWT 등록)
    A->>B: CONNECT
    B-->>A: CONNACK
...
| Clean Start / Session Expiry   | true / 0 | 세션 비보존 — 단절 중 메시지를 Broker가 보관하지 않음. 아래 근거 참조 |
...
**Clean Start=true·Session Expiry=0 근거**: 단절 중 Broker에 쌓인 Job 지시가 재연결 시 뒤늦게 배달되면, Core는 이미 그 AMMR을 단절 처리하고 해당 Job을 종료한 뒤라 AMMR이 폐기된 Job을 수행할 위험이 있다. 세션을 보존하지 않아 이 위험을 원천 차단한다. 대신 AMMR은 재연결할 때마다 SUBSCRIBE를 다시 수행하고 일괄 보고(A-1)를 재발행한다 (§7.4).
...
| A-9 재로드 요청                          | AMMR 요청   | 응답 = C-4 재로드 응답. 응답 미도착 시 담당자가 태블릿에서 재시도  |
...
|-----|-----------------------------------|-------------------------|----------------------------------------------|---------------------------|
| A-1 | `ammr/{ammr_id}/state/snapshot`   | 일괄 보고               | MQTT CONNECT 직후 / 일괄 보고 재전송 요청(C-5) 수신 시 | 발생 시점 1회       |
...
- **Trigger**: ① AMMR이 Broker에 CONNECT 한 직후 1회 ② Core의 일괄 보고 재전송 요청(C-5) 수신 시 1회
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:30:00.123Z",
  "hw_state": "idle",
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:35:12.456Z",
  "hw_state": "idle",
  "prev_state": "charging"
}
```
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:40:23.789Z",
  "slot_index": 2,
  "occupied": true
}
```
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:40:24.000Z",
  "x": 12.51,
  "y": 3.72,
  "a": 1.58
}
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:40:25.000Z",
  "battery_id": "BAT_A01",
  "soc": 87.1,
  "voltage": 50.0,
  "current": -2.0,
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:41:55.123Z",
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:42:11.234Z",
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:41:55.000Z",
  "job_id": "8c4f1b2e-5a3d-4f7c-9e80-6b1a2d3c4e5f",
  "job_type": "move",
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:42:00.000Z",
  "job_id": "9d5a44e2-6b7f-4c3a-9e21-8d0f5b6a7c43",
  "job_type": "pickup",
  "slot_target": {
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:45:00.000Z",
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:40:24.100Z",
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:42:11.500Z",
  "job_id": "9d5a44e2-6b7f-4c3a-9e21-8d0f5b6a7c43",
  "job_type": "pickup",
  "header": { "system_status": "대기", "active_slot_index": null },
  "slot": {
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T09:12:00.800Z",
  "header": { "system_status": "대기", "active_slot_index": null },
  "slots": [
    {
      "slot_index": 0,
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:35:12.600Z",
  "header": { "system_status": "대기", "active_slot_index": null }
}
```
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T07:41:56.200Z",
...
{
  "ammr_id": "ammr-001",
  "timestamp": "2026-07-10T10:05:00.400Z",
  "header": { "system_status": "대기", "active_slot_index": null },
  "slots": [
    {
      "slot_index": 0,
...
sequenceDiagram
    ...
    A->>B: CONNECT (재연결·Clean Start=true)
    B-->>A: CONNACK
...
| 표시 회신·재로드 응답 미도착   | 표시 어긋남은 적재 정보 일괄 재로드로 회복 (재로드 응답 미도착 시 담당자 재시도) | (재발행 없음)                                |
...
> 이 이력은 업체 전달 시점 milestone만 기재 — 세부 편집 이력은 사이드카(`_변경기록`).

| 버전         | 일자       | 변경 내용                                                                 |
|--------------|------------|---------------------------------------------------------------------------|
| v0.1 (Draft) | 2026-05-15 | 초안 작성 (Core SRS v2.0 Draft / Core SAD v1.0 Draft 기반)                |
| v0.1 (Draft) | 2026-05-15 | 외부 표기 정리·표기 일관성·수신 확인 도입·헤더 표기 통일 (자체 Review 라운드 1) |
| v0.1 (Draft) | 2026-05-15 | 자체 Review 라운드 2 — 변경 이력 d1/d2 분리                                |
| v0.1 (Draft) | 2026-05-15 | 자체 Review 라운드 3 — §10.B 표 정렬·§10.C #20 관련 절 보충             |
| v0.1 (Draft) | 2026-05-15 | 수신 확인 사항 SRS d67 sync + §10.C #20 행 제거·표 정렬                    |
| v0.1 (Draft) | 2026-05-19 | 외부전달 Fork 어휘 자연어화 적용 (인수인계 §6.19에 따른 어휘 풀이)           |
| v0.1 (Draft) | 2026-07-10 | 전면 재작성 — 업체 협의 폐지·전량 Core 확정([협의] 제거), Core→AMMR 표시 회신·재로드 요청/응답·일괄 보고 재전송 요청 신설, HW 상태 8종 확정, Charge 단일 Job·스테이션 태블릿 설정 일원화, 목적지 논리 라벨 확정, Clean Start=true, sensor_value·priority 필드 제거 |
...
| 9  | 수명 주기     | Clean Start = true · Session Expiry = 0 (세션 비보존·stale Job 원천 차단)  | §3.6        |
...
| 18 | 인증          | 사용자명/비밀번호 (TLS 없음·사내망 전제)                                   | §9.1        |
