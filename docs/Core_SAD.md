...
> 이 문서는 `Core_SAD_v1_0_d157.md` 기준으로 작성되었습니다.
...
| AMMR Slot | AMMR 태블릿 slot_state 판정 | Dashboard 수동 입력 | AMMR Pickup·Dropoff 동작 보고 |
